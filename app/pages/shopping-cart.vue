  ...
  <v-container>
    ...
    <div class="d-flex justify-space-between align-center mt-6">
      ...
      <div class="d-flex gap-3">
        <v-btn class="text-none" color="#ff7337" variant="flat" @click="continueShopping()">
          Mua hàng
        </v-btn>
...
const headers = [
  ...
  },
  {
    title: "Số lượng",
    key: "quantity",
    headerProps: { class: "font-weight-bold text-common quantity-style" },
  },
  {
    title: "Thành tiền",
    key: "total",
...
/* nút + / - */
.no-shadow-number ::v-deep(.v-number-input__control) {
